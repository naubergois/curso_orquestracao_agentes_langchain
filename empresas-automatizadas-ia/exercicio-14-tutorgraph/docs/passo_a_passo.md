# Passo a passo — Exercício 14: TutorGraph

## 1. Ambiente
1. Na **raiz do repositório**, configure `.env` com `GOOGLE_API_KEY` (e variáveis opcionais do enunciado).
2. Na pasta `exercicio-14-tutorgraph`, execute `./run.sh` para Jupyter Lab.

## 2. Notebook
Abra e execute na ordem **`exercicio_14_sem_ecra.ipynb`** (kernel Python 3).
