# Passo a passo — Exercício 08: GovBot Cidadão

## 1. Ambiente
1. Na **raiz do repositório**, configure `.env` com `GOOGLE_API_KEY` (e variáveis opcionais do enunciado).
2. Na pasta `exercicio-08-govbot`, execute `./run.sh` para Jupyter Lab.

## 2. Notebook
Abra e execute na ordem **`exercicio_08_sem_ecra.ipynb`** (kernel Python 3).
