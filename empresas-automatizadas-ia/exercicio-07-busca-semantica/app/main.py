"""Esqueleto — Exercício 07: Busca Semântica Ltda.. Implemente o enunciado completo."""
...
app = FastAPI(title="Busca Semântica Ltda.", version="0.0.0")
