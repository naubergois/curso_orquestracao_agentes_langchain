...
# Exercício 02 — Streamlit (porta 8501).
#   ./run_streamlit.sh              → docker compose up --build -d
#   ./run_streamlit.sh --fg         → Docker em primeiro plano
#   ./run_streamlit.sh --local      → Streamlit com venv na raiz do repositório do curso
