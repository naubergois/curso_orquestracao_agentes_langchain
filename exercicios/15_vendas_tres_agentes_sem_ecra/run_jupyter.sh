...
# Exercício 15 — sem ecrã (três agentes + PostgreSQL no Docker).
#   EX15_NOTEBOOK=outro.ipynb
#   OPEN_JUPYTER_BROWSER=0
#   POSTGRES_PORT=5435  (host; dentro do compose o serviço é `db:5432`)

export JUPYTER_PORT="${JUPYTER_PORT:-8888}"
OPEN_JUPYTER_BROWSER="${OPEN_JUPYTER_BROWSER:-1}"
EX15_NOTEBOOK="${EX15_NOTEBOOK:-exercicio_15_sem_ecra.ipynb}"
...
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "  Jupyter Lab — ex. 15 sem ecrã (3 agentes + Postgres; sem token)"
echo "  URL:  ${LAB_URL}"
echo "  Postgres (host): localhost:${POSTGRES_PORT:-5435}  db=vendas_demo  user=curso"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
