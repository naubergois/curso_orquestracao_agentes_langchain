# Jupyter no Docker — ex. 13 sem ecrã (só localhost).
...
if (-not $env:EX13_NOTEBOOK) { $env:EX13_NOTEBOOK = 'exercicio_13_sem_ecra.ipynb' }
...
$nb = $env:EX13_NOTEBOOK.Replace(' ', '%20')
...
Write-Host ''
Write-Host '  Jupyter Lab — ex. 13 sem ecra (sem token)'
