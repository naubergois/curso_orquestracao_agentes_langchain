# Jupyter no Docker — ex. 9 sem ecrã (só localhost).
# Uso: .\run_jupyter.ps1
#      $env:EX09_NOTEBOOK='outro.ipynb'; .\run_jupyter.ps1
...
if (-not $env:EX09_NOTEBOOK) { $env:EX09_NOTEBOOK = 'exercicio_9_sem_ecra.ipynb' }
...
$nb = $env:EX09_NOTEBOOK.Replace(' ', '%20')
...
Write-Host ''
Write-Host '  Jupyter Lab — ex. 9 sem ecra (RAG juridico)'
