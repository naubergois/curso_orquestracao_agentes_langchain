# Jupyter no Docker — ex. 7 sem ecrã (só localhost).
# Uso: .\run_jupyter.ps1
#      $env:EX07_NOTEBOOK='outro.ipynb'; .\run_jupyter.ps1
...
if (-not $env:EX07_NOTEBOOK) { $env:EX07_NOTEBOOK = 'exercicio_7_sem_ecra.ipynb' }
...
$nb = $env:EX07_NOTEBOOK.Replace(' ', '%20')
...
Write-Host ''
Write-Host '  Jupyter Lab — ex. 7 sem ecra (sem token)'
