# Jupyter no Docker — ex. 21 sem ecrã.
...
if (-not $env:EX21_NOTEBOOK) { $env:EX21_NOTEBOOK = 'exercicio_21_sem_ecra.ipynb' }
...
$nb = $env:EX21_NOTEBOOK.Replace(' ', '%20')
...
Write-Host ''
Write-Host '  Jupyter Lab — ex. 21 sem ecra (agente marketing; sem token)'
