# Jupyter no Docker — ex. 22 sem ecrã.
...
if (-not $env:EX22_NOTEBOOK) { $env:EX22_NOTEBOOK = 'exercicio_22_sem_ecra.ipynb' }
...
$nb = $env:EX22_NOTEBOOK.Replace(' ', '%20')
...
Write-Host ''
Write-Host '  Jupyter Lab — ex. 22 sem ecra (noticias + FAISS + RAG; sem token)'
