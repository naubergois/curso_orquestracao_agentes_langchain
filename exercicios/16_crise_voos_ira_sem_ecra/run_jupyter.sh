...
# Exercício 16 — sem ecrã (crise de voos simulada + PostgreSQL no Docker).
#   EX16_NOTEBOOK=outro.ipynb
#   OPEN_JUPYTER_BROWSER=0
#   POSTGRES_PORT=5436  (host; dentro do compose o serviço é `db:5432`)

export JUPYTER_PORT="${JUPYTER_PORT:-8888}"
OPEN_JUPYTER_BROWSER="${OPEN_JUPYTER_BROWSER:-1}"
EX16_NOTEBOOK="${EX16_NOTEBOOK:-exercicio_16_sem_ecra.ipynb}"
...
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "  Jupyter Lab — ex. 16 sem ecrã (crise voos simulada; sem token)"
echo "  URL:  ${LAB_URL}"
echo "  Postgres (host): localhost:${POSTGRES_PORT:-5436}  db=crise_voos_demo  user=curso"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
