# Jupyter no Docker — ex. 8 sem ecrã (só localhost).
# Uso: .\run_jupyter.ps1
#      $env:EX08_NOTEBOOK='outro.ipynb'; .\run_jupyter.ps1
...
if (-not $env:EX08_NOTEBOOK) { $env:EX08_NOTEBOOK = 'exercicio_8_sem_ecra.ipynb' }
...
$nb = $env:EX08_NOTEBOOK.Replace(' ', '%20')
...
Write-Host ''
Write-Host '  Jupyter Lab — ex. 8 sem ecra (chains complexas)'
