# Jupyter no Docker — ex. 3 sem ecrã (só localhost).
# Uso: .\run_jupyter.ps1
#      $env:EX03_NOTEBOOK='outro.ipynb'; .\run_jupyter.ps1
...
if (-not $env:EX03_NOTEBOOK) { $env:EX03_NOTEBOOK = 'exercicio_3_sem_ecra.ipynb' }
...
$nb = $env:EX03_NOTEBOOK.Replace(' ', '%20')
...
Write-Host ''
Write-Host '  Jupyter Lab — ex. 3 sem ecra (sem token)'
