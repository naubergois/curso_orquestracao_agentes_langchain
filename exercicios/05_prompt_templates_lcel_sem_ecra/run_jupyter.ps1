# Jupyter no Docker — ex. 5 sem ecrã (só localhost).
# Uso: .\run_jupyter.ps1
#      $env:EX05_NOTEBOOK='outro.ipynb'; .\run_jupyter.ps1
...
if (-not $env:EX05_NOTEBOOK) { $env:EX05_NOTEBOOK = 'exercicio_5_sem_ecra.ipynb' }
...
$nb = $env:EX05_NOTEBOOK.Replace(' ', '%20')
...
Write-Host ''
Write-Host '  Jupyter Lab — ex. 5 sem ecra (sem token)'
