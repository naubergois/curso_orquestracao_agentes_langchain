...
# Exercício 20 — sem ecrã (mercantil + RunnableParallel + Pydantic).
#   EX20_NOTEBOOK=outro.ipynb
#   OPEN_JUPYTER_BROWSER=0

export JUPYTER_PORT="${JUPYTER_PORT:-8888}"
OPEN_JUPYTER_BROWSER="${OPEN_JUPYTER_BROWSER:-1}"
EX20_NOTEBOOK="${EX20_NOTEBOOK:-exercicio_20_sem_ecra.ipynb}"
...
[[ -f "${REPO_ROOT}/.env" ]] || echo "Aviso: crie ${REPO_ROOT}/.env com GOOGLE_API_KEY (secção opcional com LLM)." >&2
ENV_FILE="${REPO_ROOT}/.env"
compose_env=()
[[ -f "${ENV_FILE}" ]] && compose_env+=(--env-file "${ENV_FILE}")

# shellcheck disable=SC2295
NB_ENC="${EX20_NOTEBOOK// /%20}"
...
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "  Jupyter Lab — ex. 20 sem ecrã (mercantil + paralelo + Pydantic; sem token)"
echo "  URL:  ${LAB_URL}"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
