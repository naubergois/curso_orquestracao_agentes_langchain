# Jupyter no Docker — ex. 1 sem ecrã (so localhost).
# Uso: .\run_jupyter.ps1
#      $env:EX01_NOTEBOOK='outro.ipynb'; .\run_jupyter.ps1
...
if (-not $env:EX01_NOTEBOOK) { $env:EX01_NOTEBOOK = 'exercicio_1_sem_ecra.ipynb' }
