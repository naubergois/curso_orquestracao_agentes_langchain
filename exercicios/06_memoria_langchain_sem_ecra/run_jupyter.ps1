# Jupyter no Docker — ex. 6 sem ecrã (só localhost).
# Uso: .\run_jupyter.ps1
#      $env:EX06_NOTEBOOK='outro.ipynb'; .\run_jupyter.ps1
...
if (-not $env:EX06_NOTEBOOK) { $env:EX06_NOTEBOOK = 'exercicio_6_sem_ecra.ipynb' }
...
$nb = $env:EX06_NOTEBOOK.Replace(' ', '%20')
...
Write-Host ''
Write-Host '  Jupyter Lab — ex. 6 sem ecra (memoria; sem token)'
