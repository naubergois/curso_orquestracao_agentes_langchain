...
- **Gemini (Google AI):** exercícios **00–03** e **05–11** e **13** e **17–19** (excepto o **04** e o **12**) — variável **`GOOGLE_API_KEY`** e, consoante o exercício, **`GEMINI_MODEL`** ou `GEMINI_MODEL_EXNN` (ver `.env.example`).
