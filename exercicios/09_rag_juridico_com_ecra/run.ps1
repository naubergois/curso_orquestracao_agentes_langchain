# Exercicio 09 com ecra — Predefinicao: Docker (segundo plano). Venv local: -Local. Primeiro plano: -Fg
# Uso: .\run.ps1
#      .\run.ps1 -Fg
#      .\run.ps1 -Local
...
function Invoke-RunLocalEx09Com {
...
if ($Local) {
    Invoke-RunLocalEx09Com
    exit 0
}

$ErrorActionPreference = 'Continue'
if (-not (Get-Command docker -ErrorAction SilentlyContinue)) {
    Write-Error 'Instale o Docker Desktop com docker compose.'
    exit 1
}
