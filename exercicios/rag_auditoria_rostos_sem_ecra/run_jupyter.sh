...
# RAG auditoria + rostos LFW — sem ecrã (Jupyter no Docker).
#   OPEN_JUPYTER_BROWSER=0  NOTEBOOK=outro.ipynb ./run.sh

export JUPYTER_PORT="${JUPYTER_PORT:-8888}"
OPEN_JUPYTER_BROWSER="${OPEN_JUPYTER_BROWSER:-1}"
NOTEBOOK="${NOTEBOOK:-exercicio_rag_auditoria_sem_ecra.ipynb}"
...
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "  Jupyter — RAG auditoria + rostos (LFW) sem ecrã"
echo "  URL:  ${LAB_URL}"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "  Parar: docker compose -f docker-compose.jupyter.yml down"
echo ""
...
( sleep 10 && _abrir_browser "${LAB_URL}" ) &
