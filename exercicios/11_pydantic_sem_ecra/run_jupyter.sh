...
# Exercício 11 — sem ecrã (Jupyter no Docker, Pydantic).
#   EX11_NOTEBOOK=outro.ipynb
#   OPEN_JUPYTER_BROWSER=0

export JUPYTER_PORT="${JUPYTER_PORT:-8888}"
OPEN_JUPYTER_BROWSER="${OPEN_JUPYTER_BROWSER:-1}"
EX11_NOTEBOOK="${EX11_NOTEBOOK:-exercicio_11_sem_ecra.ipynb}"
...
[[ -f "${REPO_ROOT}/.env" ]] || echo "Aviso: crie ${REPO_ROOT}/.env (necessário só para a secção opcional com Gemini)." >&2
ENV_FILE="${REPO_ROOT}/.env"
compose_env=()
[[ -f "${ENV_FILE}" ]] && compose_env+=(--env-file "${ENV_FILE}")

# shellcheck disable=SC2295
NB_ENC="${EX11_NOTEBOOK// /%20}"
...
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "  Jupyter Lab — ex. 11 sem ecrã (Pydantic; sem token: localhost)"
echo "  URL:  ${LAB_URL}"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
