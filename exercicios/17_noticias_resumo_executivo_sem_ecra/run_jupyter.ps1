# Jupyter no Docker — ex. 17 sem ecrã.
# Uso: .\run_jupyter.ps1
#      $env:EX17_NOTEBOOK='outro.ipynb'; .\run_jupyter.ps1
...
if (-not $env:EX17_NOTEBOOK) { $env:EX17_NOTEBOOK = 'exercicio_17_sem_ecra.ipynb' }
...
if (-not (Test-Path -LiteralPath $EnvFile)) {
    Write-Warning "Crie $EnvFile com GOOGLE_API_KEY (ex. 17)."
}

$nb = $env:EX17_NOTEBOOK.Replace(' ', '%20')
...
Write-Host ''
Write-Host '  Jupyter Lab — ex. 17 sem ecra (noticias + Pydantic; sem token)'
