...
# Exercício 12 — sem ecrã (Jupyter: PDF + chunking).
#   EX12_NOTEBOOK=outro.ipynb
#   OPEN_JUPYTER_BROWSER=0

export JUPYTER_PORT="${JUPYTER_PORT:-8888}"
OPEN_JUPYTER_BROWSER="${OPEN_JUPYTER_BROWSER:-1}"
EX12_NOTEBOOK="${EX12_NOTEBOOK:-exercicio_12_sem_ecra.ipynb}"
...
[[ -f "${REPO_ROOT}/.env" ]] || echo "Aviso: opcional neste exercício — sem chave LLM." >&2
ENV_FILE="${REPO_ROOT}/.env"
compose_env=()
[[ -f "${ENV_FILE}" ]] && compose_env+=(--env-file "${ENV_FILE}")

NB_ENC="${EX12_NOTEBOOK// /%20}"
...
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "  Jupyter Lab — ex. 12 sem ecrã (sem token: só localhost)"
echo "  URL:  ${LAB_URL}"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
