# Jupyter no Docker — ex. 4 sem ecrã.
# Uso: .\run_jupyter.ps1
#      $env:EX04_NOTEBOOK='outro.ipynb'; .\run_jupyter.ps1
...
if (-not $env:EX04_NOTEBOOK) { $env:EX04_NOTEBOOK = 'exercicio_4_sem_ecra.ipynb' }
...
$nb = $env:EX04_NOTEBOOK.Replace(' ', '%20')
...
Write-Host ''
Write-Host '  Jupyter Lab — ex. 4 sem ecra (sem token)'
