...
# Exercício 4 — sem ecrã (Jupyter + PostgreSQL no Docker).
#   EX04_NOTEBOOK=outro.ipynb
#   OPEN_JUPYTER_BROWSER=0

export JUPYTER_PORT="${JUPYTER_PORT:-8888}"
OPEN_JUPYTER_BROWSER="${OPEN_JUPYTER_BROWSER:-1}"
EX04_NOTEBOOK="${EX04_NOTEBOOK:-exercicio_4_sem_ecra.ipynb}"
...
[[ -f "${REPO_ROOT}/.env" ]] || echo "Aviso: crie ${REPO_ROOT}/.env com DEEPSEEK_API_KEY (ex. 4)." >&2
ENV_FILE="${REPO_ROOT}/.env"
compose_env=()
[[ -f "${ENV_FILE}" ]] && compose_env+=(--env-file "${ENV_FILE}")

# shellcheck disable=SC2295
NB_ENC="${EX04_NOTEBOOK// /%20}"
...
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "  Jupyter Lab — ex. 4 sem ecrã (sem token: só localhost)"
echo "  URL:  ${LAB_URL}"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
