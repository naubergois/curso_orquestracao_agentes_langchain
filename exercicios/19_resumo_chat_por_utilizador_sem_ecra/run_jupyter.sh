...
# Exercício 19 — sem ecrã (LangGraph + Postgres: resumo por utilizador).
#   EX19_NOTEBOOK=outro.ipynb
#   OPEN_JUPYTER_BROWSER=0
#   POSTGRES_PORT=5437  (host; dentro do compose o serviço é `db:5432`)

export JUPYTER_PORT="${JUPYTER_PORT:-8888}"
OPEN_JUPYTER_BROWSER="${OPEN_JUPYTER_BROWSER:-1}"
EX19_NOTEBOOK="${EX19_NOTEBOOK:-exercicio_19_sem_ecra.ipynb}"
...
[[ -f "${REPO_ROOT}/.env" ]] || echo "Aviso: crie ${REPO_ROOT}/.env com GOOGLE_API_KEY (Gemini)." >&2
ENV_FILE="${REPO_ROOT}/.env"
compose_env=()
[[ -f "${ENV_FILE}" ]] && compose_env+=(--env-file "${ENV_FILE}")

# shellcheck disable=SC2295
NB_ENC="${EX19_NOTEBOOK// /%20}"
...
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "  Jupyter Lab — ex. 19 sem ecrã (resumo de chat + Postgres; sem token)"
echo "  URL:  ${LAB_URL}"
echo "  Postgres (host): localhost:${POSTGRES_PORT:-5437}  db=chat_memoria_demo  user=curso"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
