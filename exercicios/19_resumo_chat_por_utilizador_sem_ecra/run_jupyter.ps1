# Jupyter no Docker — ex. 19 sem ecrã.
# Uso: .\run_jupyter.ps1
#      $env:EX19_NOTEBOOK='outro.ipynb'; .\run_jupyter.ps1
...
if (-not $env:EX19_NOTEBOOK) { $env:EX19_NOTEBOOK = 'exercicio_19_sem_ecra.ipynb' }
...
if (-not (Test-Path -LiteralPath $EnvFile)) {
    Write-Warning "Crie $EnvFile com GOOGLE_API_KEY (Gemini)."
}

$nb = $env:EX19_NOTEBOOK.Replace(' ', '%20')
...
Write-Host ''
Write-Host '  Jupyter Lab — ex. 19 sem ecra (resumo chat + Postgres; sem token)'
